		...
		public static readonly TableDefinition JsonFile = new TableDefinition(
			...
			new[]
			{
				...
				description: "Action flags: deleteValue=1, setValue=2, replaceJsonValue=4, createJsonPointerValue=8, " +
				            ...
				            "distinctValues=512, onlyIfExists=1024, createBackup=2048, restoreOnUninstall=4096, rawValue=8192"),
				...
				new ColumnDefinition("ValueType", ColumnType.Number, 2, primaryKey: false, nullable: true, ColumnCategory.Unknown, minValue: 0, maxValue: 6, description: "How Value is converted: auto=0 (null), string=1, number=2, boolean=3, null=4, json=5, date=6."),
				new ColumnDefinition("Culture", ColumnType.String, 0, primaryKey: false, nullable: true, ColumnCategory.Formatted, description: "Culture name (e.g. de-DE) used to parse number and date values.", modularizeType: ColumnModularizeType.Property),
			},
