	...
	public static class JsonFileTableDefinitions
	{
		public static readonly TableDefinition JsonFile = new TableDefinition(
			...
			new[]
			{
				...
				new ColumnDefinition("Flags", ColumnType.Number, 4, primaryKey: false, nullable: false, ColumnCategory.Unknown,  minValue: 0, maxValue: 65536, description: "deleteValue=1,setValue=2,addArrayValue=4,createJsonPointerValue=8"),
